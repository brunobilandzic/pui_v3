...
def main():
    start = State()
    recursive_bfs_path =  recursive_bfs(start, set())
    print()
    print("recursive bfs path took visiting", len(recursive_bfs_path), "states")
    print()
    for state in recursive_bfs_path:
    ...
    recursive_dfs_path = recursive_dfs(start, set())
    print()
    print("recursive dfs path took visiting", len(recursive_dfs_path), "states")
    print()
    for state in recursive_dfs_path:
        print(state.prof_key())
    print()
